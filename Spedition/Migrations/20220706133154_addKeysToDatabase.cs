...
{
    public partial class addKeysToDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    driver_city = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Speditions", x => x.id_spedition);
                    table.ForeignKey(
                        name: "FK_Speditions_Driver_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Driver",
                        principalColumn: "id_driver",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Speditions_Trailer_TrailerId",
                        column: x => x.TrailerId,
                        principalTable: "Trailer",
                        principalColumn: "id_trailer",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Speditions_Truck_TruckId",
                        column: x => x.TruckId,
                        principalTable: "Truck",
                        principalColumn: "id_truck",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Speditions_DriverId",
                table: "Speditions",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_Speditions_TrailerId",
                table: "Speditions",
                column: "TrailerId");

            migrationBuilder.CreateIndex(
                name: "IX_Speditions_TruckId",
                table: "Speditions",
                column: "TruckId");
